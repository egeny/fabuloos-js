(function( scope ) {
	...
	function FlashMediaRenderer() {
		var
			config   = Renderer.merge( arguments[0], FlashMediaRenderer.config ), // Retrieve the config and merge with the defaults
	...
	FlashMediaRenderer.plugin = {
		minVersion:  "10.1",
		webmVersion: "12", // WebM support was annonced but still not here
